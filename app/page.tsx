...
// Diperbarui agar mendukung komponen <Link> dari Next.js dengan sempurna
  ...
  return (
    <main className="relative min-h-screen text-[#1A1A1A] selection:bg-[#990000] selection:text-white pt-32 pb-24 px-4 md:px-6 max-w-[1400px] mx-auto flex flex-col justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 auto-rows-[minmax(180px,auto)] gap-4 md:gap-5 relative z-10">
        ...
        <GlassCard href="/profil" delay="0.1s" className="md:col-span-8 md:row-span-2 p-0 bg-[#1A1A1A] hover:bg-[#111] border-none group relative overflow-hidden">
          <img src="https://images.unsplash.com/photo-1596422846543-74c6fc0e2811?auto=format&fit=crop&q=80" alt="Nagari" className="absolute inset-0 w-full h-full object-cover opacity-50 mix-blend-luminosity group-hover:scale-105 group-hover:opacity-60 transition-all duration-1000" />
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-10 w-full z-10 flex flex-col md:flex-row justify-between items-end gap-6">
            <div>
              ...
              <p className="text-gray-300 text-sm md:text-base max-w-xl font-medium">Harmoni pembangunan infrastruktur dan pelestarian warisan leluhur di tanah ulayat Nagari Demo.</p>
            </div>
            <button className="shrink-0 flex items-center gap-3 text-sm font-bold text-[#990000] bg-white px-6 py-3.5 rounded-full hover:bg-[#F9F9FB] hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)]">
        ...
        <GlassCard href="/layanan" delay="0.3s" className="md:col-span-2 md:row-span-1 p-6 flex flex-col justify-center items-center text-center group bg-gradient-to-br from-white/80 to-[#990000]/5 hover:to-[#990000]/10">
        ...
        {/* 4. AGENDA CARD */}
        <GlassCard delay="0.4s" className="md:col-span-2 md:row-span-1 p-5 flex flex-col group relative overflow-hidden">
          ...
          <div className="flex gap-4 items-center mb-auto">
            <div className="flex flex-col items-center justify-center bg-white border border-gray-200 rounded-xl w-14 h-14 shrink-0 shadow-sm">
              <span className="text-[10px] font-bold text-[#990000] uppercase">Okt</span>
              <span className="text-xl font-black text-[#1A1A1A] leading-none">15</span>
            </div>
            <div>
              <h4 className="text-sm font-bold text-[#1A1A1A] leading-tight mb-1 group-hover:text-[#990000] transition-colors">Gotong Royong Irigasi Banda Gadang</h4>
              <p className="text-[11px] text-gray-500 flex items-center gap-1"><MapPin size={10}/> Dusun Krajan</p>
            </div>
          </div>
        </GlassCard>

        {/* 5. UMKM CARD */}
        <GlassCard href="/umkm" delay="0.5s" className="md:col-span-4 md:row-span-1 p-0 flex flex-col justify-end relative overflow-hidden group">
          <img src="https://images.unsplash.com/photo-1605814589255-6d60527c76ec?auto=format&fit=crop&q=80" alt="UMKM" className="absolute inset-0 w-full h-full object-cover opacity-80 group-hover:scale-105 transition-transform duration-700" />
          ...
          <div className="relative z-10 p-5 w-full flex justify-between items-end">
            <div>
              ...
              <h3 className="text-lg font-bold text-white leading-tight">Pusat Kerajinan<br/>Kain Tenun & Kuliner</h3>
            </div>
            <button className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white hover:bg-[#D4AF37] hover:text-black transition-colors border border-white/30">
        ...
        {/* 6. BERITA UTAMA CARD */}
        <GlassCard href="/berita" delay="0.6s" className="md:col-span-6 md:row-span-1 p-5 flex items-center gap-5 group">
          <div className="w-28 h-28 shrink-0 rounded-2xl overflow-hidden relative shadow-inner">
            <img src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=800&auto=format&fit=crop" alt="Berita" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
            <div className="absolute top-2 left-2 bg-white/90 backdrop-blur-sm px-2 py-0.5 rounded text-[9px] font-bold text-[#990000] uppercase shadow-sm">Kaba Baru</div>
          </div>
          <div className="flex-1">
            <p className="text-[11px] font-bold text-gray-500 mb-1">17 Juni 2026</p>
            <h3 className="text-lg font-serif font-bold text-[#1A1A1A] mb-2 leading-snug group-hover:text-[#990000] transition-colors">Program MBG Digugat ke MK, Muhammadiyah Minta Penghentian...</h3>
            <span className="text-xs font-bold text-[#990000] flex items-center gap-1">Baca Selengkapnya <ChevronRight size={14}/></span>
          </div>
        </GlassCard>

        {/* 7. PENGADUAN CARD */}
        <GlassCard href="/aspirasi" delay="0.7s" className="md:col-span-2 md:row-span-1 p-5 flex flex-col justify-center items-center text-center bg-[#990000] text-white hover:bg-[#800000] border-none group cursor-pointer shadow-[0_10px_30px_rgba(153,0,0,0.2)]">
          <ShieldCheck size={32} className="mb-3 text-[#D4AF37] group-hover:scale-110 transition-transform" />
          <h4 className="text-sm font-bold mb-1">Lapor Wali!</h4>
          <p className="text-[10px] text-white/70 font-medium">Layanan aduan warga 24 Jam</p>
        </GlassCard>
